...
export const products: Product[] = [
  {
    ...
    image: ganeshaImage,
    price: 2999,
    description: "Intricately crafted 3D Ganesha idol with golden finish",
    category: "Featured",
    material: "Premium PLA with Gold Coating",
    dimensions: "12cm x 8cm x 15cm",
    detailedDescription:
      "Our Divine Ganesha idol is a masterpiece of modern 3D printing technology combined with traditional craftsmanship. Each detail, from the delicate lotus petals to the intricate jewelry, is precisely rendered to bring the essence of Lord Ganesha into your sacred space. The golden metallic finish adds a divine touch that catches light beautifully.",
  },
  {
    id: "lakshmi-1",
